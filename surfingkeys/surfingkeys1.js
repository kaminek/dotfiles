...
settings.scrollStepSize = 140; // scrolls in one step with size
settings.focusAfterClosed = 'last';
settings.modeAfterYank = 'Normal';
Hints.setCharacters('yuiopnm'); // for right hand search
// ---- Unmap -----
// Proxy Stuff
api.unmap('spa');
api.unmap('spb');
...
// Scroll Page Down/Up
api.mapkey('<Ctrl-f>', '#9Forward half page', function() { Normal.feedkeys('5j'); });
api.mapkey('<Ctrl-b>', '#9Back half page', function() { Normal.feedkeys('5k'); });
// Tab Next/Prev
api.mapkey('J', 'R');
api.mapkey('K', 'E');
// Next/Prev Page
...
// Search
addSearchAlias('w', 'wordreference', 'https://www.wordreference.com/enfr/', 's');
